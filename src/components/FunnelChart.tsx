        ...
        {stages.map((stage, idx) => {
          ...
          return (
            <div
              ...
              className={`relative flex items-center w-full min-h-[40px] px-2 py-1 rounded-xl transition-all duration-150 cursor-pointer ${
            ...
            >
              ...
              {/* Divider line */}
              <div className="w-[1px] h-8 bg-gray-200 mr-3 shrink-0" />
              ...
              <div className="flex-1 flex justify-center items-center relative py-1">
                ...
                {isNarrow && (
                  <span className="ml-2.5 text-xs font-bold text-gray-900 bg-gray-100 px-2 py-0.5 rounded-md border border-gray-200 shrink-0 whitespace-nowrap shadow-2xs">
                    {formatNumber(stage.count)}
                  </span>
                )}
              </div>
